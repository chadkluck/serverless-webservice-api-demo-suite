...
const { root, ball, games, eluna, umwug, echo, test, weather } = require('./dao/index.js');
		...
		const main = async () => {
			...
			return new Promise(async (resolve, reject) => {
				...
				try {
					...
					let response = generateErrorResponse(new Error("Application encountered an error. Main", "500"));
					timerMain.stop();
					reject( response );
				};
			});
